              ...
              switch (stroke) {
                case 'original-or-fill-or-preferred':
                  if (!value['stroke'] || value['stroke'] === 'none')
                    ...
                    else value.stroke = parentStroke || preferredColor;
                  break;
                case 'fill-or-original-or-preferred':
                  if (value['fill'] && value['fill'] !== 'none')
                    value.stroke = value.fill;
                  else if (!value['stroke'] || value['stroke'] === 'none')
                    value.stroke = parentStroke || preferredColor;
                  break;
                case 'preferred':
                  value.stroke = preferredColor;
                  break;
                case 'none':
                  value.stroke = 'none';
                  break;
              ...
              switch (fill) {
                case 'original-or-stroke-or-preferred':
                  if (!value['fill'] || value['fill'] === 'none')
                    ...
                    else value.fill = preferredColor;
                  break;
                case 'preferred':
                  value.fill = preferredColor;
                  break;
                case 'none':
                  value.fill = 'none';
                  break;
